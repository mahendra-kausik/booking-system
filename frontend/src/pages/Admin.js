    ...
    return (
        <div className="mt-3 mtl-3 mr-3 bs">
            <div className="admin-section">
                <h1 className="admin-text">BookingSystem Management</h1>
                                    ...
                                    <>
                                        {users.map((user, index) => (
                                            <tr key={index}>
                                                ...
                                                <td data-label>{user.isAdmin ? <h1><Tag color="green">Administrator</Tag></h1> : <h1><Tag color="blue">BookingSystem Member</Tag></h1>}</td>
                                                <hr />
                                            </tr>
                                        ))}
                                    </>
